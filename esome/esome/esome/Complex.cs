...
namespace esome
{
    ...
    public class Complex
    {
        ...
        {
            return new Complex(real * Math.Cos(angle / 180 * Math.PI) - imaginary * Math.Sin(angle / 180 * Math.PI), real * Math.Sin(angle / 180 * Math.PI) + imaginary + Math.Cos(angle / 180 * Math.PI));
        }
        #endregion

        #endregion rectangular coordinates
